...
const Derivatives : React.FC<RouteComponentProps> = ({ history } : RouteComponentProps) => {
  ...
  const acbrcs = useStreamQueries(ACBRC).contracts;
        ...
        {acbrcs.map((a, i) => (
          <TableRow key={i} className={classes.tableRow}>
            ...
            <TableCell key={6} className={classes.tableCell}>
              <IconButton color="primary" size="small" component="span" onClick={() => history.push("/apps/lifecycling/derivatives/" + a.contractId.replace("#", "_"))}>
