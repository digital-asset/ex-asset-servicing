...
export const setup = async (ledger : Ledger, csd : Party) => {
  ...
  const ubsg      = createAsset(csd, "UBSG.S", "10000.0");
  ...
  await Promise.all([
    ledger.create(AssetCategorization, { id: usd[0], assetType: "Currency", assetClass: "FX", observers: { textMap: { [bank]: {} } } }),
    ledger.create(AssetCategorization, { id: eur[0], assetType: "Currency", assetClass: "FX", observers: { textMap: { [bank]: {} } } }),
    ledger.create(AssetCategorization, { id: chf[0], assetType: "Currency", assetClass: "FX", observers: { textMap: { [bank]: {} } } }),
    ledger.create(AssetCategorization, { id: csgn[0], assetType: "Stock", assetClass: "Equity", observers: { textMap: { [bank]: {} } } }),
    ledger.create(AssetCategorization, { id: ubsg[0], assetType: "Stock", assetClass: "Equity", observers: { textMap: { [bank]: {} } } }),
    ledger.create(AssetCategorization, { id: csgnCall[0], assetType: "Option", assetClass: "Equity", observers: { textMap: { [bank]: {} } } }),
    ledger.create(AssetCategorization, { id: ubsgPut[0], assetType: "Option", assetClass: "Equity", observers: { textMap: { [bank]: {} } } }),
    ledger.create(AssetCategorization, { id: acbrc[0], assetType: "Exotic", assetClass: "Equity", observers: { textMap: { [bank]: {} } } }),
    ledger.create(AssetCategorization, { id: bond[0], assetType: "Bond", assetClass: "FixedIncome", observers: { textMap: { [bank]: {} } } }),
  ]);
  ...
  await Promise.all([
    ledger.create(Currency, { id: usd[0], isoCode: "USD", observers: { textMap: { [bank]: {} } } }),
    ledger.create(Currency, { id: eur[0], isoCode: "EUR", observers: { textMap: { [bank]: {} } } }),
    ledger.create(Currency, { id: chf[0], isoCode: "CHF", observers: { textMap: { [bank]: {} } } })
  ]);

  await Promise.all([
    ledger.create(EquityStock, { id: csgn[0], ccy: chf[0], observers: { textMap: { [bank]: {} } } }),
    ledger.create(EquityStock, { id: ubsg[0], ccy: chf[0], observers: { textMap: { [bank]: {} } } })
  ]);

  await Promise.all([
    ledger.create(EquityOption, { id: csgnCall[0], underlyingId: csgn[0], optionType: OptionType.CALL, exerciseType: ExerciseType.EUROPEAN, strike: "7.0", contractSize: "100.0", maturity: "2019-09-21", settlementType: SettlementType.CASH, observers: { textMap: { [bank]: {} } } }),
    ledger.create(EquityOption, { id: { signatories: { textMap: { [csd]: {} } }, label: "CSGN-CALL-Oct19", version: "0" }, underlyingId: csgn[0], optionType: OptionType.CALL, exerciseType: ExerciseType.EUROPEAN, strike: "7.0", contractSize: "100.0", maturity: "2019-10-21", settlementType: SettlementType.CASH, observers: { textMap: { [bank]: {} } } }),
    ledger.create(EquityOption, { id: { signatories: { textMap: { [csd]: {} } }, label: "CSGN-CALL-Nov19", version: "0" }, underlyingId: csgn[0], optionType: OptionType.CALL, exerciseType: ExerciseType.EUROPEAN, strike: "8.0", contractSize: "100.0", maturity: "2019-11-21", settlementType: SettlementType.CASH, observers: { textMap: { [bank]: {} } } }),
    ledger.create(EquityOption, { id: { signatories: { textMap: { [csd]: {} } }, label: "CSGN-CALL-Dec19", version: "0" }, underlyingId: csgn[0], optionType: OptionType.CALL, exerciseType: ExerciseType.EUROPEAN, strike: "8.0", contractSize: "100.0", maturity: "2019-12-21", settlementType: SettlementType.CASH, observers: { textMap: { [bank]: {} } } }),
    ledger.create(EquityOption, { id: { signatories: { textMap: { [csd]: {} } }, label: "CSGN-CALL-Jan20", version: "0" }, underlyingId: csgn[0], optionType: OptionType.CALL, exerciseType: ExerciseType.EUROPEAN, strike: "9.0", contractSize: "100.0", maturity: "2020-01-21", settlementType: SettlementType.CASH, observers: { textMap: { [bank]: {} } } }),
    ledger.create(EquityOption, { id: { signatories: { textMap: { [csd]: {} } }, label: "CSGN-CALL-Feb20", version: "0" }, underlyingId: csgn[0], optionType: OptionType.CALL, exerciseType: ExerciseType.EUROPEAN, strike: "9.0", contractSize: "100.0", maturity: "2019-02-21", settlementType: SettlementType.CASH, observers: { textMap: { [bank]: {} } } }),
    ledger.create(EquityOption, { id: { signatories: { textMap: { [csd]: {} } }, label: "CSGN-CALL-Mar20", version: "0" }, underlyingId: csgn[0], optionType: OptionType.CALL, exerciseType: ExerciseType.EUROPEAN, strike: "9.0", contractSize: "100.0", maturity: "2019-03-21", settlementType: SettlementType.CASH, observers: { textMap: { [bank]: {} } } }),
    ledger.create(EquityOption, { id: ubsgPut[0], underlyingId: ubsg[0], optionType: OptionType.PUT, exerciseType: ExerciseType.EUROPEAN, strike: "9.0", contractSize: "100.0", maturity: "2019-07-20", settlementType: SettlementType.CASH, observers: { textMap: { [bank]: {} } } }),
    ledger.create(EquityOption, { id: { signatories: { textMap: { [csd]: {} } }, label: "UBSG-PUT-Aug19", version: "0" }, underlyingId: ubsg[0], optionType: OptionType.PUT, exerciseType: ExerciseType.EUROPEAN, strike: "9.5", contractSize: "100.0", maturity: "2019-08-21", settlementType: SettlementType.CASH, observers: { textMap: { [bank]: {} } } }),
    ledger.create(EquityOption, { id: { signatories: { textMap: { [csd]: {} } }, label: "UBSG-PUT-Sep19", version: "0" }, underlyingId: ubsg[0], optionType: OptionType.PUT, exerciseType: ExerciseType.EUROPEAN, strike: "9.5", contractSize: "100.0", maturity: "2019-09-21", settlementType: SettlementType.CASH, observers: { textMap: { [bank]: {} } } }),
    ledger.create(EquityOption, { id: { signatories: { textMap: { [csd]: {} } }, label: "UBSG-PUT-Oct19", version: "0" }, underlyingId: ubsg[0], optionType: OptionType.PUT, exerciseType: ExerciseType.EUROPEAN, strike: "9.5", contractSize: "100.0", maturity: "2019-10-21", settlementType: SettlementType.CASH, observers: { textMap: { [bank]: {} } } }),
    ledger.create(EquityOption, { id: { signatories: { textMap: { [csd]: {} } }, label: "UBSG-PUT-Nov19", version: "0" }, underlyingId: ubsg[0], optionType: OptionType.PUT, exerciseType: ExerciseType.EUROPEAN, strike: "10.0", contractSize: "100.0", maturity: "2019-11-21", settlementType: SettlementType.CASH, observers: { textMap: { [bank]: {} } } }),
    ledger.create(EquityOption, { id: { signatories: { textMap: { [csd]: {} } }, label: "UBSG-PUT-Dec19", version: "0" }, underlyingId: ubsg[0], optionType: OptionType.PUT, exerciseType: ExerciseType.EUROPEAN, strike: "10.0", contractSize: "100.0", maturity: "2019-12-21", settlementType: SettlementType.CASH, observers: { textMap: { [bank]: {} } } }),
    ledger.create(EquityOption, { id: { signatories: { textMap: { [csd]: {} } }, label: "UBSG-PUT-Jan20", version: "0" }, underlyingId: ubsg[0], optionType: OptionType.PUT, exerciseType: ExerciseType.EUROPEAN, strike: "10.0", contractSize: "100.0", maturity: "2020-01-21", settlementType: SettlementType.CASH, observers: { textMap: { [bank]: {} } } })
  ]);

  await ledger.create(ACBRC, { id: acbrc[0], underlyingId: ubsg[0], currencyId: chf[0], knockInBarrier: "0.8", knockInBarrierHit: false, callBarrier: "1.0", callBarrierHit: false, fixingDates: ["2019-06-15", "2019-09-15", "2019-12-15"], fixingIdx: "1", coupon: "0.05", initialFixing: "10.0", observers: { textMap: { [bank]: {} } } });
  ...
  await Promise.all([
    ledger.create(Fixing, { id: ubsg[0], currency: chf[0], date: "2019-06-15", value: "9.0", observers: { textMap: { [bank]: {} } } }),
    ledger.create(Fixing, { id: ubsg[0], currency: chf[0], date: "2019-09-15", value: "7.6", observers: { textMap: { [bank]: {} } } }),
    ledger.create(Fixing, { id: ubsg[0], currency: chf[0], date: "2019-12-15", value: "10.4", observers: { textMap: { [bank]: {} } } }),
    ledger.create(Fixing, { id: { signatories: { textMap: { [csd]: {} } }, label: "UBSG.S", version: "1" }, currency: chf[0], date: "2019-06-15", value: "4.5", observers: { textMap: { [bank]: {} } } }),
    ledger.create(Fixing, { id: { signatories: { textMap: { [csd]: {} } }, label: "UBSG.S", version: "1" }, currency: chf[0], date: "2019-09-15", value: "3.8", observers: { textMap: { [bank]: {} } } }),
    ledger.create(Fixing, { id: { signatories: { textMap: { [csd]: {} } }, label: "UBSG.S", version: "1" }, currency: chf[0], date: "2019-12-15", value: "5.2", observers: { textMap: { [bank]: {} } } })
  ]);
