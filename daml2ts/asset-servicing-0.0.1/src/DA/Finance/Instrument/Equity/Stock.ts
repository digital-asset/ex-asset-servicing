...
export const EquityStock: daml.Template<EquityStock, EquityStock.Key, '616828b22c8c054f0b0b0cf357ea20e3c5e6ab1ec4d6fe819a5362ec32d3518a:DA.Finance.Instrument.Equity.Stock:EquityStock'> & {
  ...
  EquityStock_SetObservers: {
    ...
    resultDecoder: () => daml.ContractId(EquityStock).decoder(),
  },
};
// eslint-disable-next-line @typescript-eslint/no-namespace
export namespace EquityStock {
  export type Key = DA_Finance_Types.Id
}
daml.registerTemplate(EquityStock);
