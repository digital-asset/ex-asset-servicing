...
export declare type InstrumentLifecycle_ObserveNextFixing = {
    instrumentId: Types.Id;
    fixing: daml.Numeric;
};
export declare const InstrumentLifecycle_ObserveNextFixing: daml.Serializable<InstrumentLifecycle_ObserveNextFixing>;
...
export declare const InstrumentLifecycle: daml.Template<InstrumentLifecycle, InstrumentLifecycle.Key, '616828b22c8c054f0b0b0cf357ea20e3c5e6ab1ec4d6fe819a5362ec32d3518a:Lifecycle.EqACBRC:InstrumentLifecycle'> & {
