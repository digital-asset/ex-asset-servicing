...
exports.EquityCashDividend_SetObservers = ({
...
exports.EquityCashDividend = {
    ...
    EquityCashDividend_SetObservers: {
        ...
        argumentDecoder: exports.EquityCashDividend_SetObservers.decoder,
        resultDecoder: function () { return daml.ContractId(exports.EquityCashDividend).decoder(); },
    },
};
daml.registerTemplate(exports.EquityCashDividend);
//# sourceMappingURL=CashDividend.js.map